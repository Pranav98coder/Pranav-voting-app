...
const ElectionGrid = ({ elections, onSelect }) => {
          ...
          >
            ...
            <div>
              ...
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="shrink-0 px-2 py-1 text-[10px] uppercase font-bold tracking-wider rounded bg-slate-100 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
                  Edit
                </span>
              </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
              {ename.started ? (
                ...
                <div className="flex items-center gap-2 text-slate-500 bg-slate-100 px-3 py-1 rounded-full border border-slate-200">
